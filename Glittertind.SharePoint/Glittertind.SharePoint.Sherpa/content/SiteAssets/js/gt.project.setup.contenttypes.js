...
GT.jQuery.extend(GT.Resources, {
    "columns_group": "Glittertind Columns",
    "contenttypes_group": "Glittertind Content Types"
});
...
GT.Project.Setup.ContentTypes.CreateLookupSiteColumn = function (displayName, internalName, targetList, showField, id, required, multiSelect, description) {
    ...
    clientContext.executeQueryAsync(function () {
        ...
        clientContext.executeQueryAsync(function () {
            ...
            fieldDeclaration.push('<Field Type="' + fieldType + '" Group="' + GT.Resources.columns_group + '" PrependId="TRUE" ');
    ...
    clientContext.executeQueryAsync(function () {
        if (!GT.Project.Setup.ContentTypes.DoesContentTypeExistInCollection(contentTypeCollection, internalName)) {
            ...
            if (parentContentType != null) {
                ...
                contentTypeInfo.set_group(GT.Resources.contenttypes_group);
