...
<asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <SharePoint:ScriptLink Name="~sitecollection/SiteAssets/gt/js/jquery.lyncpresence.js" runat="server" Language="javascript" ></SharePoint:ScriptLink>
...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="padding: 5px 10px 10px 10px;">
        <tr>
            <td valign="top" width="80%" style="padding: 5px 10px 10px 10px;">
            ...
            <td valign="top" width="20%" style="padding: 5px 10px 10px 10px;">
