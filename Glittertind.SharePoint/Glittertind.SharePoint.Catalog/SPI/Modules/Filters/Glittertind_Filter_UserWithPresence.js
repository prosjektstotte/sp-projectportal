...
function DisplayTemplate_e4314dc1d87a496bb99293c1cc551683(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_e4314dc1d87a496bb99293c1cc551683.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fFilters\u002fGlittertind_Filter_UserWithPresence.js';
...
,''
  ...
  AddPostRenderCallback(ctx, function(){
    GT.jQuery(".gt-userPresence").filter(function() { return GT.jQuery(this).data("userpresence") != 1; }).each(function() {
      var membership = GT.jQuery(this).data("membership");
      var type = GT.jQuery(this).data("imntype");
      GT.jQuery(this).createpresence(membership, {type: type, redirectToProfile: false} );
      GT.jQuery(this).data("userpresence", 1)
    });
  });

    this.Options = {
        ShowClientPeoplePicker: true,
        ShowCounts: false
    };
...
,'            ', Srch.U.collapsibleRefinerTitle(ctx.RefinementControl.propertyName, ctx.ClientControl.get_id(), refinerCatTitle, iconClass) ,''
           ...
           var imnId = 0;
            ...
            function outputFilter(refinementValue, refinementCount, refiners, method, aClass, showCounts) {
                var refinementValues = refinementValue ? refinementValue.split(" | ") : "";
                ...
                if(refinementValue != "All") {
                  var email = refinementValue.split(" | ")[0];
                  var displayName = refinementValue.split(" | ")[1];
                  var misc = refinementValue.split(" | ")[2];
                  var membership = misc ? encodeURIComponent(misc.split(" ")[1].substring(0,6)) + misc.split(" ")[1].substring(6) : "";
ms_outHtml.push(''
,''
,'              <div id="Value" name="Item" style="width: auto;">'
,'                  <a id="FilterLink" class="', $htmlEncode(aClass) ,'" onclick="', aOnClick ,'" href="javascript:{}" title="', $htmlEncode(String.format(Srch.U.loadResource("rf_RefineBy"), displayName)) ,'">'
,'                      <div id="RefinementName" class="', nameClass ,' gt-userPresence" data-membership="', membership ,'" data-imntype="withpicture">'
,'                      ', $htmlEncode(refinementValue) ,''
,'                      </div>'
,'                  </a>'
,'              </div>'
);
...
ms_outHtml.push(''
,'            <div id="Value" name="Item" style="width: auto;">'
,'              <a id="FilterLink" class="', $htmlEncode(aClass) ,'" onclick="', aOnClick ,'" href="javascript:{}" title="', $htmlEncode(String.format(Srch.U.loadResource("rf_RefineBy"), refinementValue)) ,'">'
,'                <div id="RefinementName" class="', nameClass ,'">'
,'                ', $htmlEncode(refinementValue) ,''
,'                </div>'
,'            </a>'
,'          </div>'
...
function RegisterTemplate_e4314dc1d87a496bb99293c1cc551683() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("4", DisplayTemplate_e4314dc1d87a496bb99293c1cc551683);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fFilters\u002fGlittertind_Filter_UserWithPresence.js", DisplayTemplate_e4314dc1d87a496bb99293c1cc551683);
}

}
RegisterTemplate_e4314dc1d87a496bb99293c1cc551683();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fDisplay Templates\u002fFilters\u002fGlittertind_Filter_UserWithPresence.js"), RegisterTemplate_e4314dc1d87a496bb99293c1cc551683);
}